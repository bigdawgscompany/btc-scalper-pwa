...
describe("validateContributionArithmetic", () => {
  it("passes for valid contributions", () => {
    const analysis = makeAnalysis({
      ...
      supporters: 3,
      groupContributions: [
        { groupName: "RSI", vote: 1, contribution: 25, reason: "test" },
        { groupName: "CCI", vote: 1, contribution: 25, reason: "test" },
        { groupName: "MACD", vote: 1, contribution: 25, reason: "test" },
  ...
  it("rejects contribution != vote * 25", () => {
    // Intentionally invalid contribution value to test validation
    const analysis = makeAnalysis({
      groupContributions: [
        { groupName: "RSI", vote: 1, contribution: 20 as 25, reason: "wrong" },
